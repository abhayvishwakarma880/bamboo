  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/emcee-profile" element={<PageWrapper><EMCEEProfilePage /></PageWrapper>} />
        ...
        <Route path="/social-profile" element={<PageWrapper><SocialProfile /></PageWrapper>} />
        <Route path="/social-profile/:portfolioId" element={<PageWrapper><SocialProfile /></PageWrapper>} />
