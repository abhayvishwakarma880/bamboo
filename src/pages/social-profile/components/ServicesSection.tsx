...
const socialInHouseCapabilities = [
  'Custom Stage & Mandap Decor',
  'Exquisite Floral Styling',
  'Professional Photography & Cinematic Reels',
  'High-End Sound & Ambient Uplighting',
  'LED Video Wall Visual Flows',
  'Artist & Celebrity Guest Booking',
  'Anchor & Emcee Coordinators',
  'Custom Gifting & Invitation Solutions',
  'Trained Security & Event Ushers',
  'Turnkey Event Logistics & Permissions',
];

const socialAccordionSections = {
  pre: {
    title: 'Pre-Event Curation',
    items: [
      'Bespoke mood board & visual design concepts',
      'Venue selection & vendor negotiation',
      'Budget planning & vendor management',
      'Custom menu planning & catering coordination',
      'Detailed itinerary & day-by-day guest schedules',
      'Digital invitations & RSVP tracking',
      'Backstage choreography & entry layouts',
    ],
  },
  onsite: {
    title: 'On-the-Day Management',
    items: [
      'Onsite setup coordination & decorator supervision',
      'Guest hospitality, styling, and welcoming crew',
      'Backstage artist coordination & show flow control',
      'Run-of-show supervision & MC synchronization',
      'Post-event teardown & logistics wrap-up',
    ],
  },
};
            ...
            <div className="mt-12 grid gap-6 lg:grid-cols-2">
              <div className="rounded-3xl border border-white/10 bg-[#10140c]/72 p-7 backdrop-blur-md">
                ...
                <ul className="mt-6 space-y-3">
                  {socialInHouseCapabilities.map((item, index) => (
              ...
              <div className="space-y-4">
                {(Object.keys(socialAccordionSections) as Array<'pre' | 'onsite'>).map((key) => {
                  const section = socialAccordionSections[key];
