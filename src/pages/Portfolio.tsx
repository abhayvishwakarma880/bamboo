...
import { type EventType, getDefaultPortfolioIdForEventType } from "../lib/eventRoute";
...
const Portfolio: React.FC = () => {
  ...
  const selectedApiPortfolioId = selectedProject
    ? selectedProject.category === "Social"
      ? getDefaultPortfolioIdForEventType("social")
      : getDefaultPortfolioIdForEventType("corporate")
    : getDefaultPortfolioIdForEventType("corporate");

  const selectedEventType: EventType =
    selectedProject?.category === "Social" ? "social" : "corporate";
