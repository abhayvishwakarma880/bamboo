...
import { Camera, Hammer, Megaphone, MonitorPlay, Printer, ShieldCheck, Star, Theater, Trophy, Volume2 } from 'lucide-react';
...
const serviceIcons: LucideIcon[] = [
  Theater, Hammer, Volume2, MonitorPlay,
  Camera, Printer, Trophy, Star, ShieldCheck, Megaphone,
];
